...
if __name__ == "__main__":
    lambda1_range = np.arange(0.040, 0.06, 0.0005)
    lambda2_range = np.arange(0.040, 0.06, 0.0005)
    ...
    for lambda1, lambda2 in zip(lambda1_set.ravel(), lambda2_set.ravel()):
        ...
        _, ad = calc_access_delay_u(pL, tt, tf, W, K, lambda1)
        _, ad2 = calc_access_delay_u(pL2, tt, tf, W, K, lambda1)
        p_ans.append(pL)
        p_ans2.append(pL2)
